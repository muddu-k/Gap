                    ...
                    if dependancycheck:
                        for z in y:                        
                            if z.tag[34:] in ['relcount']:
                                # add <relcount>
                                myjobdict[z.tag[34:]] = z.text + ' Job Dependancy Differences'                            
            ...
            if mydict[key] == mydict2[key]:
                ...
                for elem in mydict[key]:
                    ...
                    if elem in mydict2[key]:
                        #print('mydict[key][elem]=',mydict[key][elem])
                        #print('mydict2[key][elem]=',mydict2[key][elem])
                        ...
                        if ((elem in job_defaults) or (elem == 'request')) and (mydict[key][elem] == 'false'):
                            #do not add or track the defaults as some xml files have them others do not                            
                            dave = 1
                        else:                            
                            keycount = keycount + 1
                            print('mydict=',mydict[key][elem])
        ...
        if key in mydict:
            for elem in mydict2[key]:
                if elem not in mydict[key]:
                    if ((elem in job_defaults) or (elem == 'request')) and (mydict2[key][elem] == 'false'):
                        #do not add or track the defaults as some xml files have them others do not
                        dave = 1
                    else:                        
                        nodifferences = False
...
def main():
    ...
    finalnewaddjobs = checknewjobsdata(finalnewaddjobs,ConfigSettingsFilePath)
...
def checknewjobsdata(testdic, ConfigSettingsFilePath):
    import os
    jobname = ''
